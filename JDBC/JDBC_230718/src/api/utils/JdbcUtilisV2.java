...
内部包含一个连接池对象，并且对外提供获取连接和回收连接的方法!
 ...
 优势: 事务操作的时候 service  dao 属于同一个线程，不同再传递参数了!
 大家都可以调用getConnection 自动获取的是相同的连接池!
*/

public class JdbcUtilisV2 {
    ...
    static{
        ...
        InputStream ips = JdbcUtilisV2.class.getClassLoader().getResourceAsStream("druid.properties");
